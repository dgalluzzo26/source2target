...
--
-- INCLUDES: source_tables_physical, source_columns_physical, source_domain
--
...
INSERT INTO ${CATALOG_SCHEMA}.mapped_fields (
  ...
  'Employee Source', 'employee_source',
  'Emp SSN', 'emp_ssn',
...
-- 1.3 INITCAP + TRIM transformation - Last Name
INSERT INTO ${CATALOG_SCHEMA}.mapped_fields (
  semantic_field_id, tgt_table_name, tgt_table_physical_name, 
  tgt_column_name, tgt_column_physical_name, tgt_comments,
  source_expression, 
...
INSERT INTO ${CATALOG_SCHEMA}.mapped_fields (
  ...
  'Employees | Addresses', 'employees | addresses',
  'City Name', 'city_name',
...
INSERT INTO ${CATALOG_SCHEMA}.mapped_fields (
  ...
  'Title Desc | Title Cd', 'title_desc | title_cd',
  'Title description from title reference lookup | Employee title code',
  'VARCHAR(50) | VARCHAR(5)', 'employee',
  'JOIN', 'COALESCE',
...
INSERT INTO ${CATALOG_SCHEMA}.mapped_fields (
  ...
  'Employees | Addresses', 'employees | addresses',
  'Unit Num | Addr Line 2', 'unit_num | addr_line_2',
...
INSERT INTO ${CATALOG_SCHEMA}.mapped_fields (
  ...
  'Current Employees | Historical Employees', 'current_employees | historical_employees',
  'Middle Name | Mid Nm', 'middle_name | mid_nm',
  'Full middle name from current system | Middle name from legacy system',
  'VARCHAR(50) | VARCHAR(30)', 'employee',
  'UNION', 'UPPER, SUBSTR',
...
INSERT INTO ${CATALOG_SCHEMA}.mapped_fields (
  ...
  'New Hires | Legacy Employees', 'new_hires | legacy_employees',
  'Hire Date | Start Dt', 'hire_date | start_dt',
...
-- 5.1 Tenant Code - System field (hardcoded literal)
INSERT INTO ${CATALOG_SCHEMA}.mapped_fields (
  semantic_field_id, tgt_table_name, tgt_table_physical_name, 
  tgt_column_name, tgt_column_physical_name, tgt_comments,
  source_expression, 
...
-- ============================================================================
-- 
-- Mapped Fields Created (16 total):
...
-- - source_tables_physical: Physical database table names (pipe-separated)
-- - source_columns_physical: Physical database column names (pipe-separated)
-- - source_domain: Domain category for restore on delete
--
-- Mapping Feedback (Rejections): 3 records
-- Unmapped Fields: 15 records for AI testing
--
-- ============================================================================
